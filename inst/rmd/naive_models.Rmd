...
This report presents prediction errors of different models for different horizons (from 1 to 7 days ahead).

The specified error is **medium squared error**.
...
* Linear regression on the last 7 days of consumption, where the y-axis is consumption and the x-axis is index of the day.
* Linear regression on the last 7 days, where the y-axis is consumption and x-axis is temperature from preceding days. These models used the forecast temperature.

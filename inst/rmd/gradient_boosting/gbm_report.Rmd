...
To build a model, a minimum of `r min_num_days` of data days is required. 
...
The tables show **means squared error** for each horizon (from 1 to 7 days ahead) and for each iteration of the model.
